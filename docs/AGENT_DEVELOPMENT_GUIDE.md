...
| 组件 | 版本 | 已验证能力 |
| --- | --- | --- |
| StopWatch 固件 | v0.10.0 | 两套 UI、A/B 键、摇晃、实时 BLE 麦克风、额度、四小时热力图、四 Agent、推理滑动、中心四向 Radial |
| macOS Bridge | v1.3.0 | BLE Companion、虚拟麦克风、Typeless 状态、额度与活动同步、HID 重连恢复、推理等级同步与回退 |
